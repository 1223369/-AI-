...
// VITE_GLOB_APP_SHORT_NAME = 智能体平台 → 全大写后英文变大写、中文不变 →
//   __PRODUCTION__智能体平台__CONF__
// 改了 short_name 就要同步改这里的变量名，否则 bundle 读到 undefined 会解构报错。
//
// 字段名必须是 VITE_GLOB_*，与 .env.production 一致；改完只需重建容器，无需重新构建镜像。
window.__PRODUCTION__智能体平台__CONF__ = {
  VITE_GLOB_APP_TITLE: "智能体平台",
  VITE_GLOB_APP_SHORT_NAME: "智能体平台",
  VITE_GLOB_API_URL: "http://localhost:7126",
